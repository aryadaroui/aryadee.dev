	...
	<main>
		<div class="overlay-pad">
			<div class="overlay">
				<blockquote>
					<p>
						However, I continue to try and I continue, indefatigably, to reach out. There's no way I
						can single-handedly save the world or, perhaps, even make a perceptible difference—but
						how ashamed I would be to let a day pass without making one more effort. <span
							class="author">― <em>Isaac Asimov</em></span
						>
					</p>
				</blockquote>
			</div>
